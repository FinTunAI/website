...
export const GoogleGeminiEffect = ({
  ...
  return (
    <div className={cn("sticky lg:top-1/5 xl:top-1/5", className)}>
      ...
      <h1 class="text-4xl md:text-6xl  text-center leading-tight">
...
<g id="end-labels">
  ...
  <g>
    <rect x={1404} y={406} width={240} height={50} rx={10} strokeWidth="2" stroke="#fff"  />
    <text x={1415} y={438} fontSize="25" fill="#FFF">Trigger Frameworks</text>
  </g>
  <g>
