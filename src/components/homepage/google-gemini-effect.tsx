...
export const GoogleGeminiEffect = ({
  ...
  return (
    <section data-nav-theme="dark" id="hero" className=" bg-black w-full dark:border dark:border-white/[0.1] rounded-md relative pt-40 overflow-clip min-h-screen">
...
//                   </Badge>
//                 </div>
//       <p className="text-lg md:text-7xl font-normal pb-4 text-center bg-clip-text text-transparent bg-gradient-to-r from-[#446dcd] via-[#4bb6d3] to-[#6ef2cc]">
//   {title || `Transform Legacy Systems with AI-Driven Modernization`}
// </p>
//       {/* <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
//         {description ||
//           `From Salesforce to Enterprise Applications - Unlock the Future of
//             Your BusinessFrom Salesforce to Enterprise Applications - Unlock the Future of
//              Your Business`}
//       </p> */}
//       <p className="text-xs md:text-xl font-normal text-center text-neutral-400 mt-4 max-w-lg mx-auto">
//         {description ||
//           `From Salesforce to Enterprise Applications `}
//       </p>
//       <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
//         <button className="font-bold bg-white rounded-full px-2 py-1 md:px-4 md:py-2 mt-8 md:mt-24 text-xs md:text-base text-black w-fit mx-auto z-30">
//   <Image src="/images/ncodericon.jpg" alt="Ncode Icon" width={24} height={24} />
// </button>
//       </div>
//       <svg
//         width="1440"
