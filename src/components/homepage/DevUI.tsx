...
//   // Map 0 to 20% of scroll to opacity 1 → 0
...
//         <motion.h1
//       style={{ opacity }}
//       className="text-4xl md:text-6xl font-bold text-center text-black/90"
//     >
//       Start your work
//     </motion.h1>
...
// //
// // GridCards layout with the trigger
// //
...
//   return (
//     <div className="relative z-10 pt-40 min-h-[300vh] bg-white">
...
//   }}
//           className="fixed top-1/3 left-0 right-0 z-50 flex justify-center mx-auto gap-2 md:gap-4 lg:gap-6 pointer-events-auto"
//         >
//           {pastThreshold ? (
...
//       <div className="sticky top-50 z-30 ">
//       <StackedText />
//     </div>
...
export function StackedText() {
  const { scrollYProgress } = useScroll()
  const opacity = useTransform(scrollYProgress, [0.1, 0.5, 0.5], [0, 1, 0])
  ...
  className="
    ...
    text-4xl md:text-6xl font-bold text-center text-black/90 absolute top-30 left-1/3
    bg-white z-30 py-6
  "
>
  Start your work
...
function GridCards({ triggerRef, revealed }) {
  ...
  return (
    <div className="relative z-10 pt-40 min-h-[120vh] bg-white">
      <div className="grid grid-cols-7 items-start pt-32 px-4 gap-2 relative">
        {Array.from({ length: 7 }).map((_, colIdx) => {
          const isSwapColumn = colIdx === 2 || colIdx === 3 || colIdx === 4;
